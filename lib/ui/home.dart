...
class _HomePageState extends State<HomePage> {
  ...
  void fetchToDos() {
    _toDoListTiles = [];
    List<String> localStorageToDoKeys = html.window.localStorage.keys.toList();
    ...
    _toDoListTiles = localStorageToDoKeys
        .map(
          (e) => ListTile(
            title: Text(html.window.localStorage[e]),
            subtitle: Text(e),
          ),
        )
        .toList()
                ...
                return AlertDialog(
                  ...
                  actions: <Widget>[
                    FlatButton(
                      ...
                      onPressed: () {
                        Navigator.pop(context);
                        html.window.localStorage[DateTime.now().toString()] = [
...
class _AlertDialogThemerState extends State<AlertDialogThemer> {
  String _primaryColor = html.window.localStorage['primaryColor'];
  String _accentColor = html.window.localStorage['accentColor'];
  String _theme = html.window.localStorage['theme'];
        ...
        FlatButton(
          onPressed: () {
            if (_primaryColor != null && _theme != null) {
              html.window.localStorage['theme'] = _theme;
              html.window.localStorage['primaryColor'] = _primaryColor;
              html.window.localStorage['accentColor'] = _accentColor;
              widget._themer(
